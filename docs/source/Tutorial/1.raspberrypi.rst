...
Because this is a HAT, no jumper wires are required for the Raspberry Pi. The
table below records the **on-board J1 mapping** from the module schematic for
reference. GPIO numbers use BCM numbering; the reference driver uses SPI0 CE0
at 4 MHz.
